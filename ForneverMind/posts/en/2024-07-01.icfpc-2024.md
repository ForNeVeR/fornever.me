...
Foxtran was solving Lambdaman tasks and writing some basic solvers for them in… wait, not in Fortran? He was using C++ and Python?! That's a surprise! But actually no, keep calm. He successfully wrote Fortran in C++ any Python. As expected. He was also drawing some graphs to figure out the solutions for Spaceship.
