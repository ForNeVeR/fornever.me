    ...
    description: This year, our team was solving tasks for 2D programming language / schema layout.
---

As almost every year, [codingteam][solution] was participating in [the annual ICFP Contest][icfpc-2026].

I will document the task first, and then will provide an overview of our team's work this year.

## The Task
This year's task was a quite interesting one: we were programming 2D computation schemas, controlling groups of so-called "little men". Here I will very succinctly summarize the basics of this programming, but you are welcome to read [the interactive textbook][textbook] on the programming in this system.
...
Nevertheless: as the result, I have several bug reports in [Haskeletor][haskeletor] (IDE tooling for Haskell maintained by myself) and [CyclopsChat][cyclops-chat] (an XMPP client, also maintained by myself, that I occasionally use for checking how our XMPP bridge works). More work to do for the good of all of us!

You can read our code [here][solution], and I'll hopefully publish our official standing after it's made available (sometime during September 2026?).
